...
A minimum spanning tree connects all vertices in a graph with 
the smallest possible total weight of edges. 
Your function should take in and return 
...
#         Rebuild heap and Pop every item
        while len(unvisited_queue):
...
#         print '* Test %d : From vertex :%s to :%s shortest path : %s' %(number, from_point,t, path[::-1])
#         print out
#         print
#         number += 1
